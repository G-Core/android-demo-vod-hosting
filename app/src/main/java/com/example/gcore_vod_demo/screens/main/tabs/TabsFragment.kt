package com.example.gcore_vod_demo.screens.main.tabs
...
import gcore_vod_demo.databinding.FragmentTabsBinding
    ...
    private val destinationListener =
        NavController.OnDestinationChangedListener { _, destination, _ ->
            ...
            if (needDarkBottomMenu && !isCurrentlyBottomMenuDark) {
                binding.bottomMenu.setBackgroundColor(requireContext().getColor(R.color.grey_800))
