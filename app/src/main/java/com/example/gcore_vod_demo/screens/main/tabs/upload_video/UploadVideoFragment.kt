package com.example.gcore_vod_demo.screens.main.tabs.upload_video
...
import com.example.gcore_vod_demo.screens.main.tabs.videos.uploading.UploadingVODsViewModel
import com.example.gcore_vod_demo.utils.sharedViewModelCreator
import com.google.android.material.dialog.MaterialAlertDialogBuilder
import gcore_vod_demo.R
import gcore_vod_demo.databinding.FragmentUploadVideoBinding
...
class UploadVideoFragment : Fragment(R.layout.fragment_upload_video) {
    ...
    private val requestPermissions = registerForActivityResult(
        ...
        if (allPermissionGranted()) {
            ...
            Toast.makeText(requireContext(), R.string.camera_is_denied, Toast.LENGTH_SHORT).show()
        }
    }
