package com.example.gcore_vod_demo.screens.main.tabs.viewing.list.item
...
import com.example.gcore_vod_demo.screens.main.tabs.viewing.list.ScrollDirection
import com.example.gcore_vod_demo.screens.main.tabs.viewing.list.ViewingFragment
...
import gcore_vod_demo.databinding.FragmentVodBinding
...
class VodFragment : Fragment(R.layout.fragment_vod) {
    ...
    private val gCoreApp: GCoreApp
        get() = requireParentFragment().requireActivity().application as GCoreApp
    ...
    private fun preparePlayer(mediaItem: MediaItem) {
        val hlsMediaSource = HlsMediaSource.Factory(gCoreApp.exoPlayerUtils.cacheDataSourceFactory)
