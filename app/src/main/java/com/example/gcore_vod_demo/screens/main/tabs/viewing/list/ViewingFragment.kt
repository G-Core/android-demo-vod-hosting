...
import com.example.gcore_vod_demo.screens.main.tabs.videos.remote.RemoteVODsViewModel
...
import gcore_vod_demo.databinding.FragmentViewingBinding
...
class ViewingFragment : Fragment(R.layout.fragment_viewing) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bandwidthMeter =
            (requireActivity().application as GCoreApp).exoPlayerUtils.bandwidthMeter
